    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        return Observer(builder: (_) {
          ...
          if (asana == null) {
            Log.warn('Somehow you\'ve got empty gymfit queue item.');
           // return SizedBox.shrink();
           return Image.asset(ImageAssets.khoidong);
          }
      ...
      child: Consumer<AsanasStore>(builder: (_, asanasStore, __) {
        return Observer(builder: (_) {
          ...
          return Column(
            children: [
              Expanded(
                child: Image.asset(ImageAssets.taynguc),
              ),
              Padding(
                  ...
                  children: <Widget>[
                    ClipRRect(
                      ...
                      child: Container(
                        width: 60,
                        height: 60,
                        child: Image.asset(ImageAssets.logoCoverImage),
                      ),
                    ),
                    SizedBox(width: 12),
                    Expanded(
