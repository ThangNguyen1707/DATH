...
class _AsanaScreen extends StatelessWidget {
  final AsanaModel gymfitModel;

  const _AsanaScreen(this.gymfitModel);
    ...
    return Padding(
      ...
      child: ListView(
        children: [
         ...
         Image.asset(ImageAssets.gapbungArtImage), // TODO: Get image from model
          SizedBox(height: 15),
          Button(
            'Add to favourites',
            onTap: null           
          ...
          _getTextBlock(
            context,
            'Hướng dẫn',
            gymfitModel.description,
            Colors.tealAccent[200],
          ),
          SizedBox(height: 15),
          _getTextBlock(
            context,
            'Số hiệp cần thực hiện',
            gymfitModel.warnings,
